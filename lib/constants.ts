...
export const EXAMPLE_BOARD = {
  cards: {
    ...
    "79c73eea-9a43-4017-9117-79ae0df1de73": {
      ...
      shortcut: "",
      title: "Abraham Hannibal",
      data: "Abraham Hannibal, ou simplement appelé Hanibal (en russe : Абра́м Петро́вич Ганниба́л, Abram Pétrovitch Gannibal), né en 1696 et mort le 14 mai 1781, est un esclave, militaire et commandant afro-russe. Capturé en 1703 par des esclavagistes musulmans et amené à Constantinople, il y est acheté clandestinement pour le compte de Pierre le Grand. Devenu le secrétaire de l'empereur, il se fait remarquer par ses aptitudes intellectuelles et termine sa carrière comme général en chef dans l'Armée impériale russe.",
      folded: false,
      tags: [],
    },
    ...
    "b888d38c-0fa4-4e52-9b54-06ccb7792d47": {
      id: "b888d38c-0fa4-4e52-9b54-06ccb7792d47",
      type: "url",
      position: {
        left: 100,
        top: 493.60003662109375,
      },
      size: {
        width: 326,
        height: 40,
      ...
      favicon: "https://tailwindcss.com/favicons/apple-touch-icon.png?v=3",
...
//this one is 87kb
export const BIG_BOARD = {
  boarda: EXAMPLE_BOARD,
  boardb: EXAMPLE_BOARD,
  boardc: EXAMPLE_BOARD,
  boardd: EXAMPLE_BOARD,
  boarde: EXAMPLE_BOARD,
  boardf: EXAMPLE_BOARD,
  boardg: EXAMPLE_BOARD,
  boardh: EXAMPLE_BOARD,
  boardi: EXAMPLE_BOARD,
  boardk: EXAMPLE_BOARD,
}

//size must no exceed 400kb !!!!!
